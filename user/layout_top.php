...
<head>
    ...
    <title><?= htmlspecialchars($pageTitle ?? 'User') ?> — Inventaris Lab</title>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">
        ...
        * { font-family: 'Inter', sans-serif; box-sizing: border-box; }
        ...
        .sidebar-header h2 { color: #fff; font-size: 15px; font-weight: 700; margin: 0 0 2px; }
        .sidebar-header span { color: rgba(255,255,255,.4); font-size: 11px; text-transform: uppercase; letter-spacing: .07em; }
        ...
        .sidebar-footer { padding: 16px 12px 20px; border-top: 1px solid rgba(255,255,255,.07); }
        ...
        .sidebar-footer a.logout:hover { background: rgba(239,68,68,.15); color: #fca5a5; }
        ...
        .topbar-title { font-size: 18px; font-weight: 700; color: #111827; flex: 1; }
        .topbar-time { font-size: 13px; color: #6b7280; }

        .main-content { margin-left: var(--sidebar-w); padding-top: 64px; min-height: 100vh; }
        ...
        .page-banner h1 { font-size: 24px; font-weight: 800; margin: 0 0 4px; }
        .page-banner p { margin: 0; color: rgba(255,255,255,.75); font-size: 14px; }

        .table-card {
            background: #fff; border-radius: 16px; border: none;
            box-shadow: 0 1px 3px rgba(15,23,42,.06), 0 4px 14px rgba(15,23,42,.05); overflow: hidden;
        }
        .table-card-header { padding: 18px 24px; border-bottom: 1px solid #f3f4f6; display: flex; align-items: center; gap: 10px; }
        .table-card-header h5 { margin: 0; font-size: 15px; font-weight: 700; color: #111827; flex: 1; }
        .table > :not(caption) > * > * { padding: 13px 18px; vertical-align: middle; }
        .table thead th {
            background: #f9fafb; color: #374151; font-size: 11px; font-weight: 700;
            text-transform: uppercase; letter-spacing: .06em; border-bottom: 2px solid #e5e7eb; white-space: nowrap;
        }
        ...
        .form-card { background: #fff; border-radius: 16px; padding: 28px; border: none; box-shadow: 0 1px 3px rgba(15,23,42,.06), 0 4px 14px rgba(15,23,42,.05); }
        .form-card label { font-size: 13px; font-weight: 600; color: #374151; }
        .form-card .form-control, .form-card .form-select {
            border-radius: 10px; border: 1.5px solid #e5e7eb; font-size: 14px; padding: 10px 14px;
            transition: border-color .2s, box-shadow .2s;
        }
        .form-card .form-control:focus, .form-card .form-select:focus {
            border-color: var(--brand-secondary); box-shadow: 0 0 0 3px rgba(14,165,233,.12);
        }

        /* ===== FILTER CARD (search & filter alat) ===== */
        .filter-card {
            background: #fff; border-radius: 16px; padding: 22px 24px; border: none;
        ...
        .filter-card .form-control, .filter-card .form-select {
            border-radius: 10px; border: 1.5px solid #e5e7eb; font-size: 13.5px; padding: 9px 13px;
            transition: border-color .2s, box-shadow .2s;
        }
        ...
        .badge-kategori {
            ...
            border-radius: 50px; font-size: 11px; font-weight: 600; padding: 3px 11px;
        }

        .btn-primary-grad {
            background: var(--grad-brand);
            border: none; border-radius: 10px; color: #fff; font-weight: 600;
            padding: 10px 20px; font-size: 14px; box-shadow: 0 4px 12px rgba(37,99,235,.22);
        ...
        .stat-card:hover { transform: translateY(-4px); box-shadow: 0 8px 20px rgba(15,23,42,.12); }
        .stat-card .card-icon {
        ...
        .stat-card .card-num { font-size: 32px; font-weight: 800; line-height: 1; }
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="lab-icon"><i class="bi bi-mortarboard-fill"></i></div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="riwayat.php" class="<?= ($activePage??'') === 'riwayat' ? 'active' : '' ?>">
